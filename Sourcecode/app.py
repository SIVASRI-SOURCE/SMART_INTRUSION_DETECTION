...
def home():
    ...
    """
    st.markdown("<h1 style='text-align: center;'> AI Powered Honeypots for Advance Threat Detection and Analysis</h1>", unsafe_allow_html=True)

    # Animation
    animation_path = "background/1.webp"  # Relative path to your GIF
    ...
    st.markdown("<p style='text-align: center;'>Welcome to our AI Powered Honeypots for Advance Threat Detection and Analysis! </p>", unsafe_allow_html=True)
